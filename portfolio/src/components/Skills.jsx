  ...
  return (
    <section className="px-6 py-16 space-grotesk">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        {/* Web Design */}
        <motion.div className="p-6 rounded-xl border border-gray-200 hover:shadow-md transition" initial={{y:100,opacity:0}}  whileInView={{y:0,opacity:1}} transition={{duration:1.2,type:'string',stiffness:120}}>
        ...
        {/* Frontend */}
        <motion.div className="p-6 rounded-xl border border-gray-200 hover:shadow-md transition" initial={{y:100,opacity:0}}  whileInView={{y:0,opacity:1}} transition={{duration:1,type:'string',stiffness:120}}>
